...
(function( root, factory ) {
    ...
    return (function( module_factory ) {
        ...
        if( typeof window === "undefined" && typeof process === "object" ) {
            ...
            var wasm_path = path.join( __dirname, "art_pattern.wasm" );
            var buffer = fs.readFileSync( wasm_path );
            var mod = new WebAssembly.Module( buffer );
            var wasm_instance = new WebAssembly.Instance( mod, instance.imports );
            return instance.initialize( wasm_instance );
        } else {
            return fetch( "art_pattern.wasm", {credentials: "same-origin"} )
                .then( function( response ) { return response.arrayBuffer(); } )
                .then( function( bytes ) { return WebAssembly.compile( bytes ); } )
                .then( function( mod ) { return WebAssembly.instantiate( mod, instance.imports ) } )
                .then( function( wasm_instance ) {
                    var exports = instance.initialize( wasm_instance );
                    console.log( "Finished loading Rust wasm module 'art_pattern'" );
                    return exports;
                })
                .catch( function( error ) {
                    console.log( "Error loading Rust wasm module 'art_pattern':", error );
                    throw error;
                });
        }
    }( function() {
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        imports: {
            ...
            "__extjs_8d5a6b319ceda81ca8c1be4bfb2a7c5f258f5f36": function($0) {
                Module.STDWEB_PRIVATE.from_js($0, (function(){return Math.random ();})());
            },
            "__extjs_38702d76338b135c90cfdd4c35ff5b87a38107da": function($0) {
                Module.STDWEB_PRIVATE.from_js($0, (function(){hide_params ();})());
            },
            "__extjs_99db9ad2a9e0c735c64aa6960ae4e1dd37e5e04c": function($0) {
                Module.STDWEB_PRIVATE.from_js($0, (function(){show_params ();})());
            },
            ...
            "__extjs_19c9ac979d3a4b50a76d6f9f7dca013c7722c1b0": function($0) {
                Module.STDWEB_PRIVATE.from_js($0, (function(){close_code ()})());
            },
            "__extjs_d99ca60547d8659c7354a73a3c8458658dcf9867": function($0, $1, $2) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);Module.STDWEB_PRIVATE.from_js($0, (function(){show_code (($1), ($2))})());
            },
            ...
            "__extjs_6cbcfe66c0ba4caf569853396b7e9ecc6c99ec90": function($0, $1, $2, $3, $4) {
            ...
            "__extjs_9d9cfa8d9be703c5d41f3b3823a60088e5571bb3": function($0) {
            ...
            "__extjs_7fe6ddbfbf6a0ce7c6dbcff300d81ae1f05e9b52": function($0, $1, $2, $3, $4) {
